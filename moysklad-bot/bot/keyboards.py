...
# Shared fine-grained period picker used by both "📅 Отчёт" and
# "👥 Команда": 1/10/20/30 days, then every month up to a year.
...
def cp_period_choice_kb(prefix: str = "cpperiod") -> InlineKeyboardMarkup:
